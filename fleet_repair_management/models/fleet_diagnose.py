...
class fleet_diagnose(models.Model):
    ...
    def action_create_quotation(self):
        ...
        for fleet_line in self.fleet_repair_line:
            #if fleet_line.guarantee == 'yes' and fleet_line.guarantee_type == 'paid':
    ...
    def action_view_fleet_repair(self):
        ...
        result = mod_obj.get_object_reference('fleet_repair_management', 'action_fleet_repair_tree_view')
        id = result and result[1] or False
        result = act_obj.browse(id).read()[0]
        res = mod_obj.get_object_reference('fleet_repair_management', 'view_fleet_repair_form')
        result['views'] = [(res and res[1] or False, 'form')]
