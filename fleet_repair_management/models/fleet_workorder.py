...
class fleet_workorder(models.Model):
    ...
    fleet_repair_id = fields.Many2one('fleet.repair', string='fleet Repair', copy=False, readonly=True)
    diagnose_id = fields.Many2one('fleet.diagnose', string='fleet Diagnosis', copy=False, readonly=True)
    ...
    def action_start_working(self):
        ...
        if self.fleet_repair_id:
            self.fleet_repair_id.write({'state': 'workorder'})
        return True
